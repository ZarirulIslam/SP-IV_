...
public class LibrarianSc extends JFrame {
	static LibrarianSc frame;
	...
	public LibrarianSc() {
		...
		JLabel lblLibrarianSection = new JLabel("Librarian Section - zarir,hadi,nahid,imrul");
